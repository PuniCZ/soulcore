...
#pragma warning(default:4355)
    ...
    /* soulcore */
    rpState = RP_STATE_ALL;
   /* m_customScaleMod = 0.0f;
    m_customScaleActive = false;    
    */ 
    /*\soulcore */
}
...
bool Player::LoadFromDB(uint32 guid, SQLQueryHolder *holder)
{
    ...
    //"health, power1, power2, power3, power4, power5, power6, power7, instance_id, speccount, activespec, exploredZones, equipmentCache, ammoId, knownTitles, actionBars, grantableLevels, rpState FROM characters WHERE guid = '%u'", guid);
    ...
    /* soulcore*/
    SetRpState(RpState(fields[67].GetUInt8()));
    /*\soulcore*/
    InitDisplayIds();
